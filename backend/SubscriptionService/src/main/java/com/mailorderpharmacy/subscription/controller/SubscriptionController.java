...
public class SubscriptionController {
	...
	public ResponseEntity<String> subscribes(@RequestBody PrescriptionDetails prescriptionDetails) {
		
		System.out.println(prescriptionDetails.toString());
		log.info("Inside subscribe controller method");
		return subscriptionService.subscribes(prescriptionDetails);
	}
	/** Unsubscribe Service */
	/**
	...
	public List<PrescriptionDetails> getAllSubscriptions() {
