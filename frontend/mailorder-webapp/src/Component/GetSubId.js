...
//         try {
//             const res = await axios.get(`http://localhost:8082/subscriptionapi/getAllSubscriptions/${drugId.Id}`, {
//                 method: "get",
//                 url: `http://localhost:8082/subscriptionapi/getAllSubscriptions/${drugId.Id}`,    
//             headers: {
