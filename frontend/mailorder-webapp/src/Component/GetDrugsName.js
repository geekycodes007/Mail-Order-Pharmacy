...
function GetDrugsName() {
    ...
    const fetchData = async () => {
        ...
        try {
            const res = await axios.get(`http://localhost:8081/drugdetailapp/searchDrugsByName/${drugName.Name}`,{
                method: "get",
                url: `http://localhost:8081/drugdetailapp/searchDrugsByName/${drugName.Name}`,    
            headers: {
                        ...
                        <Form onSubmit={(e) => handleSubmit(e)}>
                            <Form.Group className="mb-3">
                                <Form.Control type='text' name="Name"
                                    value={drugName.Name} required
                                    placeholder='Enter Drug Name'
                                    onChange={(e) => setDrugName((prevState) => ({
                                        ...prevState,
                                        Name: e.target.value,
                                    }))} />
                            </Form.Group>
